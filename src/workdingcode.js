  ...
  render() {
    ...
    return (
      <div className="appContainer">
		      ...
		      <h1> Ohm Value {(option0 + option1) * option2}</h1>
		      <h1> Minimum {(option0 + option1) * option2 * (1 - option3)}</h1>
		      <h1> Maximum {(option0 + option1) * option2 * (1 + option3)}</h1>
		      <div className="resistorImg">
		      	<div></div>
		      </div>
		    </div>
      	</div>
